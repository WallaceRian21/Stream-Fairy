                ...
                <div class="card-body" style="color:chartreuse">
                    <form action="{{ route('filme.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="id_categoria" type="number" class="form-control @error('id_categoria') is-invalid @enderror" name="id_categoria" value="{{ old('id_categoria') }}" required autocomplete="id_categoria" autofocus>
